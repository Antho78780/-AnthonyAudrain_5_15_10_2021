...
for (let product of getLocal){
    const totalArticle = document.querySelector("#totalQuantity").innerHTML += `${product.quantite}` ;
    const totalPrice = document.querySelector("#totalPrice").innerHTML += `${product.price}`;
